---
layout: default
title: "Hybrid Genetic Algorithm-Simulated Annealing (HGASA) Algorithm for Presentation Scheduling"
description: "This repository demonstrates how the Presentation Scheduling problem, which is analogous to the famous University Course Timetabling Problem (UCTP), can be solved using the Hybrid Genetic Algorithm-Simulated Annealing (HGASA) algorithm."
---
...
<p align=center><img src="{{ BASE_PATH }}/docs/pics/HGASA_Flowchart.png" width=70% height=70%></p>
...
<p align=center><img src="{{ BASE_PATH }}/docs/pics/matrices.png" width=70% height=70%></p>
...
<p align=center><img src="{{ BASE_PATH }}/docs/pics/crossover.png" width=90% height=90%></p>
...
<p align=center><img src="{{ BASE_PATH }}/docs/pics/mutation.png" width=50% height=50%></p>
...
<p align=center><img src="{{ BASE_PATH }}/docs/pics/simulated_annealing.png" width=80% height=80%></p>
...
<p align=center><img src="{{ BASE_PATH }}/docs/pics/result_graph.png" width=50% height=50%></p>
